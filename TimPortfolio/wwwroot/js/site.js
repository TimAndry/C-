    ...
    var option2 = {};
      ...
      if(windowwidth >= 1024){
        if($(".projects").is(':visible')){   
          option1["left"] = "10%";
          option2["left"] = "10%";
          $("#pj1, #pj2, #pj3, #gh1, #gh2, #gh3 ").rotate({
            duration:600,
            angle: 0,
            animateTo:-90
          });
          $( "#p2" ).animate(option1, "fast");
          $( "#p3" ).delay(25).animate(option2, "fast");
          $(".projects").delay(100).slideUp("fast");
          $("#pj1, #pj2, #pj3, #gh1, #gh2, #gh3").removeClass("avatar");
          // $("#projects").css("background-color", "rgb(255,255,255,0)");
          return false;
        }else{
          // $("#projects").css("background-color", "rgb(255,255,255,0.2)");
          $(".projects").slideDown("fast");
          option1["left"] = windowwidth * 0.35;
          option2["left"] = windowwidth * 0.6;
          $( "#p2" ).delay(25).animate(option1, "fast");
          $( "#p3" ).animate(option2, "fast");
          $("#pj1, #pj2, #pj3, #gh1, #gh2, #gh3 ").rotate({
            duration:600,
            angle: 270,
            animateTo:360
    ...
    $("#circle2").click(function(e){
      $("#circle2").rotate({
		...
		$("#contactbtn").click(function(e){
			...
			option1["left"] = windowwidth * -0.125;
			option1["top"] = windowheight * -0.20;

			option2["left"] = windowwidth * 0.125;
			option2["top"] = windowheight * -0.20;

			option3["left"] = windowwidth * -0.155;
			option3["top"] = windowheight * 0.010;

			option4["left"] = windowwidth * 0.175;
			option4["top"] = windowheight * 0.085;

			option5["left"] = windowwidth * 0.001;
			option5["top"] = windowwidth * 0.120;

			$( "#fname" ).animate(option1);
			$( "#lname" ).animate(option2);
			$( "#email" ).animate(option3);
			$( "#comment" ).animate(option4);
			$( "#submit" ).animate(option5)
			setTimeout(function(e){
					$("#fname").addClass("justbounce");
			},200);
			setTimeout(function(e){
				$("#lname").addClass("justbounce");
			},400);
			setTimeout(function(e){
				$("#email").addClass("justbounce");
			},600);
			setTimeout(function(e){
				$("#comment").addClass("justbounce");
			},800);
			setTimeout(function(e){
				$("#submit").addClass("avatar");
			},0);
		});
...
function SetTimer() {
  var Timer1 = setInterval("showImage1()", 1200);
  var Timer2 = setInterval("showImage2()", 1300);
  var Timer3 = setInterval("showImage3()", 1400);
  var Timer4 = setInterval("showImage4()", 2500);
  var Timer5 = setInterval("showImage5()", 3500);
  var Timer6 = setInterval("showImage6()", 4500);
  var Timer7 = setInterval("showImage7()", 200);
  var Timer8 = setInterval("showImage8()", 400);
  var Timer9 = setInterval("showImage9()", 600);
  var Timer10 = setInterval("showImage10()", 800);
}
function showImage1() { $("#showImage3").fadeIn("slow"); }
function showImage2() { $("#showImage2").fadeIn("slow"); }        
function showImage3() {$("#showImage1").fadeIn("slow");}
function showImage4() {$("#text").show();}
function showImage5() {$("#messenger").show();}
function showImage6() {$("#plink").fadeIn();}
function showImage7() {$("#showImage4").fadeIn();}
function showImage8() {$("#showImage5").fadeIn();}
function showImage9() {$("#showImage6").fadeIn();}
function showImage10() {$("#showImage7").fadeIn();}
...
sr.reveal('#stimg', {
	...
	rotate:{x:180,y:0,z:0}, opacity: 0, scale: .9, easing: 'ease-in-out', 
...
sr.reveal('#rdimg', {
	origin: 'bottom', distance: '20px', duration: 500, delay: 200, 
	rotate:{x:180,y:0,z:0}, opacity: 0, scale: .9, easing: 'ease-in-out', 
	container: window.document.documentElement 
});

sr.reveal('#fthimg', {
	origin: 'top', distance: '10px', duration: 300, delay: 300, 
	rotate:{x:0,y:180,z:0}, opacity: 0, scale: .9, easing: 'ease-in-out', 
	container: window.document.documentElement 
});

sr.reveal('#fithimg', {
	origin: 'top', distance: '1px', duration: 300, delay: 400, 
	rotate:{x:0,y:180,z:0}, opacity: 0, scale: .9, easing: 'ease-in-out', 
	container: window.document.documentElement 
});

sr.reveal('#sthimg', {
	origin: 'top', distance: '1px', duration: 300, delay: 500, 
	rotate:{x:0,y:180,z:0}, opacity: 0, scale: .9, easing: 'ease-in-out', 
	container: window.document.documentElement 
});
...
vertex3d.prototype = {
	...
	var textSet = [
		{text:"I_AM", sphereRadius:140, sphereSpace:80, unitTime:100, time:1000},
		{text:"VERSATILE", sphereRadius:120, sphereSpace:70, unitTime:120, time:4000},
		{text:"FULLSTACK", sphereRadius:120, sphereSpace:70, unitTime:50, time:2000},
		{text:"DEVELOPER", sphereRadius:120, sphereSpace:70, unitTime:100, time:4000},
		{text:"PYTHON", sphereRadius:100, sphereSpace:60, unitTime:100, time:3000},
		{text:"@@@@@@@@", sphereRadius:140, sphereSpace:80, unitTime:100, time:2000},
		{text:"ASP_NET", sphereRadius:60 + Math.random()*60, sphereSpace:200, unitTime:100, time:4000},
		{text:"AND", sphereRadius:120, sphereSpace:70, unitTime:100, time:2000},
		{text:"MEAN", sphereRadius:100, sphereSpace:60, unitTime:150, time:3500},
		{text:"M_E_A_N", sphereRadius:120, sphereSpace:70, unitTime:50, time:2000},
		{text:"!!!!!!!", sphereRadius:100, sphereSpace:60, unitTime:100, time:3500},
		{text:"SEE_MY_PORTFOLIO", sphereRadius:140, sphereSpace:80, unitTime:100, time:2500},
